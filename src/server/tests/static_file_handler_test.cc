...
private:
  std::map<std::string, std::string> files = {
      ...
      {"schema.xml",
       "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <a v=\"asd\">text</a>"},
...
// Disabled test: premissions in cloud may be blocking file permissions
...
//     fs::permissions(fp, fs::owner_all & ~fs::owner_read);
//   });
